...
REQUIRED_PATTERNS = {
    ...
    "learned_default_config": ("smart/configs/learned_default.yaml",),
    "learned_macro_safe_config": ("smart/configs/learned_macro_safe.yaml",),
    "learned_macro_program_gate_config": ("smart/configs/learned_macro_program_gate_top3.yaml",),
    "learned_macro_refine_only_config": ("smart/configs/learned_macro_refine_only.yaml",),
    "learned_macro_mcts_guarded_config": ("smart/configs/learned_macro_mcts_replacement_guarded.yaml",),
    "learned_macro_mcts_learned_only_config": ("smart/configs/learned_macro_mcts_replacement_learned_only.yaml",),
    "learned_router_policy_v1": ("smart/assets/policies/deepset_setaware_v2_h128_v1.smartmlp",),
    "learned_router_policy_v13": ("smart/assets/policies/deepset_setaware_v2_h128_dagger_b2_v12.smartmlp",),
    "macro_skill_knowledge_base": ("smart/assets/skills/macro_skill_knowledge_base_v1.json",),
    "macro_skill_memory_policy": ("smart/assets/skills/macro_memory_policy_v1.json",),
    "macro_skill_budget_gate": ("smart/assets/skills/macro_budget_quality_rule_v1.json",),
    "macro_skill_quality_gate": ("smart/assets/skills/macro_quality_gate_ridge_v1.json",),
    "macro_skill_candidates": ("smart/assets/skills/macro_skill_candidates_4k_v1.jsonl",),
    "macro_skill_retriever": ("smart/assets/skills/macro_skill_retriever_macrohash_v1.json",),
