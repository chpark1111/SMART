...
This directory is the adapted legacy Mesh2Tet runtime kept for reference and
for the official SMART pipeline wrapper. New users should normally call the
package CLI instead of invoking this script directly:
...
The wrapper adds normalization, per-mesh retry/timeout handling, manifests, and
failure skipping around the legacy Mesh2Tet path.
